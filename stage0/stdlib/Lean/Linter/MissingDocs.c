...
v___x_1012_ = lean_array_get_borrowed(v___x_1007_, v_es_1006_, v_j_1011_);
lean_dec(v_j_1011_);
...
lean_inc_ref_n(v_fileMap_1890_, 2);
...
lean_inc_n(v_macroStack_3874_, 2);
