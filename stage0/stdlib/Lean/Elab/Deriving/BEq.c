...
v_auxFunName_3845_ = lean_array_get_borrowed(v___x_3843_, v_auxFunNames_3839_, v___x_3844_);
v___x_3846_ = 0;
...
lean_inc_n(v_currMacroScope_3842_, 5);
lean_inc_n(v_quotContext_3841_, 5);
...
lean_inc_n(v_macroStack_4244_, 2);
