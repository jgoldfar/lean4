...
v___x_1629_ = l_Lean_Elab_Tactic_Do_SpecAttr_isSpecInvariantType(v_env_1628_, v_a_1621_);
lean_dec(v_a_1621_);
if (v___x_1629_ == 0)
{
...
lean_inc_n(v_currMacroScope_3417_, 2);
lean_inc_n(v_quotContext_3416_, 2);
v___x_3432_ = l_Lean_addMacroScope(v_quotContext_3416_, v___x_3431_, v_currMacroScope_3417_);
v___x_3433_ = lean_box(0);
lean_inc_n(v___x_3418_, 14);
