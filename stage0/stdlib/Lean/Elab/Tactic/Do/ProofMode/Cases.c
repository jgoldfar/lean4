...
v___x_2409_ = lean_array_get_borrowed(v___x_2404_, v_es_2403_, v_j_2408_);
lean_dec(v_j_2408_);
...
lean_inc_n(v_openDecls_2871_, 2);
lean_inc_n(v_currNamespace_2870_, 3);
