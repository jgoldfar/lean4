...
lean_dec(v___y_637_);
v___x_643_ = l___private_Init_Data_Array_QSort_Basic_0__Array_qsort_sort___at___00Lean_Parser_Error_toString_spec__1___redArg(v___y_639_, v___y_638_, v___y_642_);
lean_dec(v___y_642_);
...
{
uint8_t v___x_651_; 
v___x_651_ = lean_nat_dec_le(v___y_650_, v___y_646_);
if (v___x_651_ == 0)
{
lean_dec(v___y_646_);
lean_inc(v___y_650_);
v___y_637_ = v___y_645_;
v___y_638_ = v___y_650_;
