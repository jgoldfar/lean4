...
v___x_4176_ = lean_array_get_borrowed(v___x_4171_, v_es_4170_, v_j_4175_);
lean_dec(v_j_4175_);
...
lean_dec_ref(v_forbiddenNatModules_4228_);
if (v___x_4229_ == 0)
{
